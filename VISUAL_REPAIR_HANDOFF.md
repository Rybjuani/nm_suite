...
- [ ] 01. `suite:dbt-practice-stop@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.70341`, odiff `8.94`, bbox `17`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `odiff_delta`. Reparar modal STOP light: tamano/posicion/backdrop/panel interno/botonera y estado de practica.
- [ ] 02. `suite:onboarding-error@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.35589`, odiff `6.18`, bbox `12`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Revisar error state, bloque legal, checkbox, scroll interno y footer.
...
- [ ] 04. `suite:onboarding@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.32642`, odiff `5.42`, bbox `3`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Separar consentimiento del panel legal como canonico y corregir footer.
...
- [ ] 09. `suite:dbt-practice-stop@dark` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.21457`, odiff `2.84`, bbox `64`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Alinear modal STOP dark: posicion/tamano/backdrop/contenido.
- [ ] 10. `suite:timer-running@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.21096`, odiff `2.03`, bbox `12`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Estado no coincide: canonico `25:00`, V8 `24:58`; estabilizar timer y layout.
- [ ] 11. `suite:timer-paused@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.20778`, odiff `2.03`, bbox `12`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Estado no coincide: canonico `15:12`, V8 `24:59`; estabilizar paused.
...
- [ ] 16. `suite:respiracion-paused@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, high. Raw changed `0.1823`, odiff `1.58`, bbox `12`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Estado no coincide: canonico `01:32` y `4` ciclos, V8 `00:00` y `0`.
...
- [ ] 19. `suite:respiracion-running@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.17315`, odiff `1.61`, bbox `12`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Estabilizar running y alinear circulo/metrics.
...
- [ ] 21. `suite:actividades-filtered@light` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.15222`, odiff `1.81`, bbox `11`. Findings: `raw_pixel_delta`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Canonico filtra `Fisica` con `Caminata 20 min`; V8 filtra `Placer` con `Escuchar musica`.
...
- [ ] 28. `suite:respiracion-paused@dark` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.10814`, odiff `1.65`, bbox `23`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Estado paused dark no coincide.
...
- [ ] 30. `suite:respiracion-running@dark` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.09707`, odiff `1.69`, bbox `23`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Estado running dark no coincide.
...
- [ ] 34. `suite:actividades-filtered@dark` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.08111`, odiff `1.89`, bbox `19`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Canonico/V8 usan filtro distinto tambien en dark.
...
- [ ] 36. `suite:timer-running@dark` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.06493`, odiff `2.11`, bbox `21`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Timer running dark: tiempo/anel/controles.
- [ ] 37. `suite:timer-paused@dark` - `STATE_RECIPE_OR_PRODUCT_FIX`, medium. Raw changed `0.06179`, odiff `2.1`, bbox `21`. Findings: `raw_pixel_delta`, `layout_drift`, `state_or_recipe_suspect`, `qa_missed_raw_or_layout`. Timer paused dark: tiempo/anel/controles.
...
- [ ] 58. `suite:respiracion@light` - `LAYOUT_FIX`, high. Raw changed `0.18659`, odiff `1.6`, bbox `12`. Findings: `raw_pixel_delta`, `layout_drift`, `qa_missed_raw_or_layout`. Respiracion light: contenedor central, circulo, metrics.
...
- [ ] 65. `suite:respiracion@dark` - `LAYOUT_FIX`, medium. Raw changed `0.10942`, odiff `1.68`, bbox `23`. Findings: `raw_pixel_delta`, `layout_drift`, `qa_missed_raw_or_layout`. Respiracion dark: contenedor central, circulo, metrics.
