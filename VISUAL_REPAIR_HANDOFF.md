...
- [x] `suite:rutina-all-completed@light` - severity=medium; findings=raw_pixel_delta,qa_missed_raw_or_layout; changed=0.15314; odiff=2.87; bbox=2; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina-all-completed_light.png`.
  ...
  - closed-by: close_visual_key.py
- [x] `suite:rutina@light` - severity=medium; findings=raw_pixel_delta,qa_missed_raw_or_layout; changed=0.1456; odiff=2.21; bbox=13; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina_light.png`.
  - evidence: d6edbe5a7b7031a7ecea69f0d655b868e167df626b25a3bc47c7ca335dab3ab6
  - evidence-record: docs/closure_evidence/suite_rutina-light.json
  - commit: 54ef0f8d0bb26277655b6811492bb7f7de9016f4
  - closed-by: close_visual_key.py
- [x] `suite:rutina-add-task@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,qa_missed_raw_or_layout; changed=0.09569; odiff=2.81; bbox=211; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina-add-task_dark.png`.
  - evidence: 3bab14f05c85ddf6ebb89c993e40df1bc7887bdc1ca2aabb4df0afc12d575ba0
  - evidence-record: docs/closure_evidence/suite_rutina-add-task-dark.json
  - commit: 0fc4fe693045a409a81f5b1a4456bea81b80e4dc
  - closed-by: close_visual_key.py
- [x] `suite:rutina-all-completed@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,qa_missed_raw_or_layout; changed=0.09193; odiff=3.23; bbox=211; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina-all-completed_dark.png`.
  - evidence: 618b2dba5f349fc0f9be182c370a3f865e0fe956bc01bac01ab22cd3044292e4
  - evidence-record: docs/closure_evidence/suite_rutina-all-completed-dark.json
  - commit: f4398efb1194662db34481f88221985ea2073175
  - closed-by: close_visual_key.py
- [x] `suite:rutina@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,qa_missed_raw_or_layout; changed=0.08561; odiff=2.52; bbox=211; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina_dark.png`.
  - evidence: 7e38cdb7795447def149266c1fe9c4f8d74ace012c55bc16390ba0b6e8c84ec9
...
- [x] `suite:rutina-empty@light` - severity=medium; findings=raw_pixel_delta,layout_drift,qa_missed_raw_or_layout; changed=0.04036; odiff=0.95; bbox=332; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina-empty_light.png`.
  ...
  - closed-by: close_visual_key.py
- [x] `suite:rutina-empty@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,qa_missed_raw_or_layout; changed=0.0324; odiff=1.03; bbox=333; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_rutina-empty_dark.png`.
  - evidence: 6ee2c18efdc8aa25783e2869df316ac31f44f38304c031d904effc1aece97fe3
  - evidence-record: docs/closure_evidence/suite_rutina-empty-dark.json
  - commit: 44f82e1570da175cbd7ea3d9d07230b59c5a9f17
  - closed-by: close_visual_key.py

### Respiracion Rings / Controls (F9, F4) (6)

- [x] `suite:respiracion@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,qa_missed_raw_or_layout; changed=0.10211; odiff=1.58; bbox=23; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_respiracion_dark.png`.
  - evidence: 4c63fa7d0ba883f43a31fbb8e2e88ff7770da8c1a246b7863d907b19e56fc636
...
- [x] `suite:respiracion@light` - severity=medium; findings=raw_pixel_delta,qa_missed_raw_or_layout; changed=0.09777; odiff=1.5; bbox=12; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_respiracion_light.png`.
  ...
  - closed-by: close_visual_key.py
- [x] `suite:respiracion-paused@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,state_or_recipe_suspect,qa_missed_raw_or_layout; changed=0.09105; odiff=1.55; bbox=23; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_respiracion-paused_dark.png`.
  - evidence: b61fc0405d56cd4a7fba4c18d90a8a1a15957e0d73f876f8d26e32d102edd3c0
  - evidence-record: docs/closure_evidence/suite_respiracion-paused-dark.json
  - commit: 1a77f7be912734c3252d21235167d654e4f4b708
  - closed-by: close_visual_key.py
- [x] `suite:respiracion-running@dark` - severity=medium; findings=raw_pixel_delta,layout_drift,state_or_recipe_suspect,qa_missed_raw_or_layout; changed=0.08741; odiff=1.58; bbox=23; panel=`reports\qa\layered_visual_compare_fresh\panels\suite_respiracion-running_dark.png`.
  - evidence: 17c3f5b69ee31461a5cdb32ae4ba50da5a306afb8065501b392c7fe298804ac0
