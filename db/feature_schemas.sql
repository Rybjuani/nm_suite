...
--
-- RLS deshabilitado en todas (consistente con las otras tablas clínicas
-- del proyecto; endurecimiento centralizado pendiente en F5.A).
...
CREATE TABLE IF NOT EXISTS public.ia_audit_log (
    ...
    provider      TEXT,   -- "Groq", "Gemini", "OpenCode", "OllamaCloud"
...
-- ── RLS deshabilitado (consistente con tablas clínicas) ──────────────────────
