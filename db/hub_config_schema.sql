...
-- ── RLS deshabilitado (consistente con el resto de tablas clínicas) ──────────
-- El proyecto usa anon key con entorno controlado. Si en el futuro se decide
-- endurecer RLS, hacerlo junto con las tablas clínicas en una sola pasada
-- documentada (ver F5.A "RLS audit").
