...
## Regla importante
No renombrar archivos internos de `03_current_app/extracted/current_app_captures` sin revisar primero las rutas relativas, porque los HTML/JSON pueden depender del orden y nombres de las capturas.
