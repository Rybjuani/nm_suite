...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | suite:dbt-library@dark | raw_pixel_delta,qa_missed_raw_or_layout | 0.10184 | 2.4 | 16 | reports\qa\layered_visual_compare_dbt_library_dark_try8\panels\suite_dbt-library_dark.png |
