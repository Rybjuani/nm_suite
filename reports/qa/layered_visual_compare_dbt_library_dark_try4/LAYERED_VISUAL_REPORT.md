...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | LAYOUT_FIX | suite:dbt-library@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.12036 | 3.48 | 39 | reports\qa\layered_visual_compare_dbt_library_dark_try4\panels\suite_dbt-library_dark.png |
