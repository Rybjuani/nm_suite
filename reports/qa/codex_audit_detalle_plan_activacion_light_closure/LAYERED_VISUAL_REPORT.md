...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | hub:detalle-plan-activacion@light | raw_pixel_delta,qa_missed_raw_or_layout | 0.10246 | 3.1 | 15 | reports\qa\codex_audit_detalle_plan_activacion_light_closure\panels\hub_detalle-plan-activacion_light.png |
