...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | suite:dbt-library@dark | raw_pixel_delta,qa_missed_raw_or_layout | 0.14219 | 4.03 | 16 | reports\qa\dbt_full_compare_after_grid\panels\suite_dbt-library_dark.png |
| medium | FAIL | VISUAL_STYLE_REVIEW | suite:dbt-library@light | raw_pixel_delta,qa_missed_raw_or_layout | 0.13243 | 3.84 | 14 | reports\qa\dbt_full_compare_after_grid\panels\suite_dbt-library_light.png |
