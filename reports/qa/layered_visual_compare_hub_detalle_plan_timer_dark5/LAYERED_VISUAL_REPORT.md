...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | LAYOUT_FIX | hub:detalle-plan-timer@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.48387 | 7.67 | 174 | reports\qa\layered_visual_compare_hub_detalle_plan_timer_dark5\panels\hub_detalle-plan-timer_dark.png |
