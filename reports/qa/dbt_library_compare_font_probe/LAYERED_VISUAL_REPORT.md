...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': None, 'keys_file': 'C:\\Users\\nosom\\AppData\\Local\\Temp\\tmp53A3.tmp', 'keys_file_keys': ['suite:dbt-library@light', 'suite:dbt-library@dark']}
...
- By repair bucket: {'VISUAL_STYLE_REVIEW': 2}

| Severity | Status | Bucket | Key | Findings | Raw changed | ODiff % | BBox delta | Panel |
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | suite:dbt-library@dark | raw_pixel_delta,qa_missed_raw_or_layout | 0.14219 | 4.03 | 16 | reports\qa\dbt_library_compare_font_probe\panels\suite_dbt-library_dark.png |
| medium | FAIL | VISUAL_STYLE_REVIEW | suite:dbt-library@light | raw_pixel_delta,qa_missed_raw_or_layout | 0.13243 | 3.84 | 14 | reports\qa\dbt_library_compare_font_probe\panels\suite_dbt-library_light.png |
