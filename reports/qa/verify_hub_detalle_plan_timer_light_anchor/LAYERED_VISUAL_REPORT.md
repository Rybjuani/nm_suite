...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'hub:detalle-plan-timer@light', 'keys_file': None, 'keys_file_keys': []}
...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | LAYOUT_FIX | hub:detalle-plan-timer@light | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.21469 | 6.15 | 18 | reports\qa\verify_hub_detalle_plan_timer_light_anchor\panels\hub_detalle-plan-timer_light.png |
