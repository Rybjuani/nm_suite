...
- Actual source: `qa\_captures_tmp`
...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@light | raw_pixel_delta,layout_drift,state_or_recipe_suspect,odiff_delta | 0.70399 | 8.83 | 64 | reports\qa\tmp_dbl_practice_stop\panels\suite_dbt-practice-stop_light.png |
...
| high | MISSING_ACTUAL | PAIRING_FIX | suite:dbt-practice-stop@dark | missing_actual |  |  |  |  |
