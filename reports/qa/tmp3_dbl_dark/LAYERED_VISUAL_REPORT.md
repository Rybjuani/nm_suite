...
- By repair bucket: {'PAIRING_FIX': 85, 'STATE_RECIPE_OR_PRODUCT_FIX': 1}

| Severity | Status | Bucket | Key | Findings | Raw changed | ODiff % | BBox delta | Panel |
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@dark | raw_pixel_delta,layout_drift,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.19428 | 2.16 | 33 | reports\qa\tmp3_dbl_dark\panels\suite_dbt-practice-stop_dark.png |
...
| high | MISSING_ACTUAL | PAIRING_FIX | suite:dbt-practice-stop@light | missing_actual |  |  |  |  |
