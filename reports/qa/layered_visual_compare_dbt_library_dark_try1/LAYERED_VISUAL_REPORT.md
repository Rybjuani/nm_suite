...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | LAYOUT_FIX | suite:dbt-library@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.12217 | 3.32 | 43 | reports\qa\layered_visual_compare_dbt_library_dark_try1\panels\suite_dbt-library_dark.png |
