...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | LAYOUT_FIX | hub:detalle-plan-timer@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.21384 | 6.25 | 19 | reports\qa\verify_hub_detalle_plan_timer_dark_rescue\panels\hub_detalle-plan-timer_dark.png |
