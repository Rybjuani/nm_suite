...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': None, 'keys_file': 'reports/qa/onb_family_keys.txt', 'keys_file_keys': ['suite:recuperar-acceso@dark', 'suite:recuperar-acceso@light', 'suite:onboarding@light', 'suite:onboarding@dark', 'suite:onboarding-error@light', 'suite:onboarding-error@dark']}
