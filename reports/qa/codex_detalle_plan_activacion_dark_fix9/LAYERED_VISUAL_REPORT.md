...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | hub:detalle-plan-activacion@dark | raw_pixel_delta,qa_missed_raw_or_layout | 0.10625 | 3.91 | 16 | reports\qa\codex_detalle_plan_activacion_dark_fix9\panels\hub_detalle-plan-activacion_dark.png |
