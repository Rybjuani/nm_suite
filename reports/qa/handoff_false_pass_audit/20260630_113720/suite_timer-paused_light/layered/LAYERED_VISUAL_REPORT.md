...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'suite:timer-paused@light', 'keys_file': None, 'keys_file_keys': []}
...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:timer-paused@light | raw_pixel_delta,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.13249 | 2.03 | 14 | C:\Users\nosom\Desktop\nm_suite\reports\qa\handoff_false_pass_audit\20260630_113720\suite_timer-paused_light\layered\panels\suite_timer-paused_light.png |
