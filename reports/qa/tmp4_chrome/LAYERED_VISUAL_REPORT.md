...
- Actual source: `qa\_captures_tmp4`
...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@light | raw_pixel_delta,layout_drift,state_or_recipe_suspect,odiff_delta | 0.19328 | 8.05 | 94 | reports\qa\tmp4_chrome\panels\suite_dbt-practice-stop_light.png |
| high | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@dark | raw_pixel_delta,layout_drift,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.18784 | 1.94 | 31 | reports\qa\tmp4_chrome\panels\suite_dbt-practice-stop_dark.png |
