...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@dark | layout_drift,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.09414 | 1.24 | 63 | reports\qa\layered_visual_compare_dbt_dark_item\panels\suite_dbt-practice-stop_dark.png |
