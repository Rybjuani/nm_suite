...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | LAYOUT_FIX | suite:dbt-library@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.1248 | 3.41 | 43 | reports\qa\layered_visual_compare_dbt_library_dark\panels\suite_dbt-library_dark.png |
