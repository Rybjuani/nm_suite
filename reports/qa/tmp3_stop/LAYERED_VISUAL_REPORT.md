...
- Actual source: `qa\_captures_tmp3`
...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@light | raw_pixel_delta,layout_drift,state_or_recipe_suspect,odiff_delta | 0.21017 | 9.11 | 96 | reports\qa\tmp3_stop\panels\suite_dbt-practice-stop_light.png |
| high | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@dark | raw_pixel_delta,layout_drift,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.19428 | 2.16 | 33 | reports\qa\tmp3_stop\panels\suite_dbt-practice-stop_dark.png |
