...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'hub:detalle@dark', 'keys_file': None, 'keys_file_keys': []}
...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | hub:detalle@dark | raw_pixel_delta,qa_missed_raw_or_layout | 0.10496 | 4.11 | 16 | reports\qa\codex_audit_detalle_dark_next\panels\hub_detalle_dark.png |
