...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@light | raw_pixel_delta,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.08471 | 1.04 | 1 | reports\qa\layered_visual_compare_dbt_light_check\panels\suite_dbt-practice-stop_light.png |
