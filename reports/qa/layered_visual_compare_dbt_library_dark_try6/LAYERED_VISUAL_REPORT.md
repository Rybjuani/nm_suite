...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | LAYOUT_FIX | suite:dbt-library@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.10378 | 2.4 | 47 | reports\qa\layered_visual_compare_dbt_library_dark_try6\panels\suite_dbt-library_dark.png |
