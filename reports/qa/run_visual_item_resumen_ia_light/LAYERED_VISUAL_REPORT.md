...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'hub:detalle-resumen-ia@light', 'keys_file': None, 'keys_file_keys': []}
- REPORT_EVIDENCE_VALID: NO
- REPORT_EVIDENCE_REASON: empty_results
- HANDOFF_CLOSURE_ALLOWED: NO
- HANDOFF_CLOSURE_REASON: empty_results
