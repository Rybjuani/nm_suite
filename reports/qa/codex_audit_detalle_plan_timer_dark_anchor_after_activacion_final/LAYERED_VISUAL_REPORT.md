...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'hub:detalle-plan-timer@dark', 'keys_file': None, 'keys_file_keys': []}
...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | VISUAL_STYLE_REVIEW | hub:detalle-plan-timer@dark | raw_pixel_delta,qa_missed_raw_or_layout | 0.10017 | 2.98 | 16 | reports\qa\codex_audit_detalle_plan_timer_dark_anchor_after_activacion_final\panels\hub_detalle-plan-timer_dark.png |
