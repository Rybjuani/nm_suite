...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:dbt-practice-stop@light | raw_pixel_delta,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.08147 | 1.3 | 1 | reports\qa\layered_visual_compare_dbt_practice_stop_light_regression\panels\suite_dbt-practice-stop_light.png |
