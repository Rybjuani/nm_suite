...
- Actual source: `qa\_captures_test`
- REPORT_SCOPE: PARTIAL
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'suite:dbt-library@light', 'keys_file': None, 'keys_file_keys': []}
- REPORT_EVIDENCE_VALID: NO
- REPORT_EVIDENCE_REASON: non_active_sources
- HANDOFF_CLOSURE_ALLOWED: NO
- HANDOFF_CLOSURE_REASON: non_active_sources
