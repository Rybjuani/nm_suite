...
- REPORT_FILTERS: {'app': None, 'view': None, 'theme': None, 'key': 'suite:recuperar-acceso@dark', 'keys_file': None, 'keys_file_keys': []}
...
|---|---|---|---|---|---:|---:|---:|---|
| medium | FAIL | STATE_RECIPE_OR_PRODUCT_FIX | suite:recuperar-acceso@dark | raw_pixel_delta,state_or_recipe_suspect,qa_missed_raw_or_layout | 0.10312 | 2.08 | 16 | reports\qa\layered_visual_compare_onboarding_dark_item\panels\suite_recuperar-acceso_dark.png |
