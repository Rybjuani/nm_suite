...
|---|---|---|---|---|---:|---:|---:|---|
| high | FAIL | LAYOUT_FIX | hub:detalle-plan-timer@dark | raw_pixel_delta,layout_drift,qa_missed_raw_or_layout | 0.21481 | 5.81 | 19 | reports\qa\layered_visual_compare_hub_detalle_plan_timer_dark8\panels\hub_detalle-plan-timer_dark.png |
