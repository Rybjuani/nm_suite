"""Compare canonical mockup targets against PyQt captures.

The report is intentionally file-name driven. The canonical source
(qa/_mockup_canonical, generated by the pack recipe) and capture_v8.py both use
names shaped as:
